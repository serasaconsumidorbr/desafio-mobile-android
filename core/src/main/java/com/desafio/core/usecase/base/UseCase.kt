package com.project.core.usecase.base
...
abstract class UseCase<in P, R>{
    operator fun invoke(param: P): Flow<ResultStatus<R>> = flow {
...
abstract class PagingUseCase<in P, R: Any>{
    ...
    suspend operator fun invoke(params: Int): Flow<List<R>> = createFlowObservable(params)
    protected abstract fun createFlowObservable(params:P): Flow<PagingData<R>>
    protected abstract suspend fun createFlowObservable(limit: Int): Flow<List<R>>
}