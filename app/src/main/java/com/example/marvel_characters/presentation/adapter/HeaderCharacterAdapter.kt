...
import com.example.marvel_characters.databinding.ItemCharacterHeaderBinding
import com.example.marvel_characters.presentation.model.CharacterModel

class HeaderCharacterAdapter :
    ListAdapter<CharacterModel, HeaderCharacterAdapter.CharacterViewHolder>(diffUtil) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CharacterViewHolder {
        val binding =
            ItemCharacterHeaderBinding.inflate(LayoutInflater.from(parent.context), parent, false)
