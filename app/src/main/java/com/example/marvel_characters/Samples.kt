...
object Samples {
    val characterWithMissingDescription = MarvelCharacter(
        id = "1009151",
        name = "Amiko",
        description = "",
    ...
    val characterWithMissingImage = MarvelCharacter(
        id = "1011031",
        name = "Agent X (Nijo)",
    ...
    val characterWithCompleteData = MarvelCharacter(
        id = "1009144",
        name = "A.I.M.",
        description = "AIM is a terrorist organization bent on destroying the world.",
        thumbnailUrl = "http://i.annihil.us/u/prod/marvel/i/mg/6/20/52602f21f29ec.jpg"
    )
    val marvelCharactersList = listOf(characterWithMissingImage, characterWithCompleteData, characterWithMissingDescription)
}