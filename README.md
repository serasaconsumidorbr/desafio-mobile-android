...
2. **Visualizar Detalhes do Personagem:** Os usuários podem selecionar um personagem da lista para visualizar os quadrinhos em que ele é mencionado ou aparece e eventos em que ele está presente.
